...
class EspaiPlugin {
  ...
  public static function add_rewrite_rules() {
    add_rewrite_rule('kinos[/]?$', 'index.php?espai_page=venue_index', 'top');
    add_rewrite_rule('kinos/([a-z0-9-]+)-([0-9]+)', 'index.php?espai_page=venue_details&espai_venue_id=$matches[2]', 'top');
