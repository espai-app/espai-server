...
@Named
@ApplicationScoped
@FacesConverter(forClass = ProductionVersion.class)
public class ProductionVersionConverter implements Converter {
  ...
  public Object getAsObject(FacesContext fc, UIComponent uic, String string) {
    try {
      ...
      return productionVersions.get(Long.parseLong(string));
  ...
  public String getAsString(FacesContext fc, UIComponent uic, Object t) {
    ...
    return String.valueOf(((ProductionVersion) t).getId());
  }
